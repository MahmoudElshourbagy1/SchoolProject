...
namespace SchoolProject.Core.Features.Students.Queries.Handlers
{
        ...
        IRequestHandler<GetStudentPaginatedListQuery, PaginatedResult<GetStudentPaginatedListResponse>>
    {
        ...
        public async Task<PaginatedResult<GetStudentPaginatedListResponse>> Handle(GetStudentPaginatedListQuery request, CancellationToken cancellationToken)
        {
            ...
            //    x.Address,
            //    x.Departments.Localize(
            //        x.Departments.DNameAr,
            //        x.Departments.DNameEn)
            //))
            var PaginatedList = await _mapper.ProjectTo<GetStudentPaginatedListResponse>(FilterQuery)
           .ToPaginatedListAsync(request.PageNumber, request.PageSize); PaginatedList.Meta = new
           {
